...
public class NetheriteChestScreenHandler extends ScreenHandler {
    ...
    public NetheriteChestScreenHandler(int syncId, PlayerInventory playerInventory) {
    ...
    public NetheriteChestScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(SimpleProgressions.NETHERITE_CHEST_SCREEN_HANDLER, syncId);
        ...
        for (m = 0; m < 8; ++m) {
            for (l = 0; l < 13; ++l) {
                this.addSlot(new Slot(inventory, l + m * 13, l * 18 + 8, m * 18 + 14));
            }
        }
        //The player inventory
        for (m = 0; m < 3; ++m) {
            for (l = 0; l < 9; ++l) {
                this.addSlot(new Slot(playerInventory, l + m * 9 + 9, 44 + l * 18, 170 + m * 18));
            }
        }
        //The player Hotbar
        for (m = 0; m < 9; ++m) {
            this.addSlot(new Slot(playerInventory, m, 44 + m * 18, 228));
        }
