...
public class IronChestBlock extends BlockWithEntity {
    ...
    public IronChestBlock(AbstractBlock.Settings settings) {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            ...
            if (blockEntity instanceof IronChestEntity) {
                player.openHandledScreen((IronChestEntity)blockEntity);
                player.incrementStat(SimpleProgressions.OPEN_IRON_CHEST);
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        if (itemStack.hasCustomName()) {
            BlockEntity blockEntity = world.getBlockEntity(pos);
            if (blockEntity instanceof IronChestEntity) {
                ((IronChestEntity)blockEntity).setCustomName(itemStack.getName());
            }
        }
